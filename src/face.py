...
def alibaba_face():
    ...
    #场景二：使用任意可访问的url
    #url = 'ht  tps://viapi-test-bj.oss-cn-beijing.aliyuncs.com/viapi-3.0domepic/facebody/SearchFace1.png'
    ...
    try:
        ...
        # 获取整体结果
        print(response.body)
        MatchList = response.body.to_map()['Data']['MatchList']
        #遍历列表得到Score、形成一个集合scores——即set集合：是一个无序不重复的集
        scores = [item['Score'] for item in MatchList[0]['FaceItems']]     
